...
enum LocalizationKey: String, CaseIterable, Sendable {
  ...
  var english: String {
    ...
    case .dictationEnglishUS: "English (US)"
    case .dictationSimplifiedChinese: "Simplified Chinese"
    case .dictationEnglishShort: "English"
    case .dictationChineseShort: "Chinese"
    case .dictationChineseEnglish: "Chinese + English"
    ...
    case .settingsDictationLanguage: "Dictation language"
    ...
    case .menuDictationLanguage: "Dictation Language"
